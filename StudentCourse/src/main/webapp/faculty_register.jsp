            ...
            <body>
                ...
                <section class="student-register">
                    <div class="container student-register__container">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Faculty Registration</h2>
                                <form class="student-register__form" action="addfaculty" method="post">
                                    <div class="form-group">
                                        <input type="text" name="name" class="form-control" placeholder="Faculty Name" required style="width: 250px;height:50px; color:white; background-color: black;">
                                        <br><br>
                                    </div>
                                    ...
                                    <br>
                                    <p>Already Have an account?<a href="/loginf"> Login</a>
                                </form>
                            </div>
                        </div>
                    </div>
