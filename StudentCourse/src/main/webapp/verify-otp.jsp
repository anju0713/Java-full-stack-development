                    ...
                    <div class="container student-login__container">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="student-login__form" action="/verify" method="POST">
                                    <div class="form-group">
                                        <input type="text" name="otp" class="form-control" placeholder="Enter Otp" required style="width: 250px; background-color: black;">
                                    <br><br>
                                    </div>
