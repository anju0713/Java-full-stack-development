...
<nav>
        ...
        <br>
        <br><br><br>
    <h1 style="text-align:center;">All Student Data</h1>
    <p style="text-align:center;"><a href="addstudent.jsp">ADD STUDENT</a></p>
        ...
        <tbody>
            <c:forEach items="${data}" var="client">
                <tr>
                    ...
                    <td>
    <a href="/delete/${client.id}">Delete</a> <!-- Add a "Delete" link -->
</td>
