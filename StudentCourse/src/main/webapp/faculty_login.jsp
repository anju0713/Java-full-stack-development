...
<section class="student-login">
                    <div class="container student-login__container">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Faculty Login</h2>
                                <form class="student-login__form" action="checkfacultylogin" method="POST">
    ...
    <div class="error-message">${msg}</div>
                                ...
                                <div class="text-center">
                                    <a href="/forgot">Forgot Password</a> | <a href="/registerf">Register</a>
                                </div>
                            </div>
                        </div>
                    </div>
