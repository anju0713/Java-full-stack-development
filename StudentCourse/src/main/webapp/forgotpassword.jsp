                    ...
                    <div class="container student-login__container">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="student-login__form" action="/forgot-password" method="POST">
                                    <div class="form-group">
                                        <input type="text" name="email" class="form-control" placeholder="Email" required style="width: 250px; background-color: black;">
                                    <br><br>
                                    </div>
